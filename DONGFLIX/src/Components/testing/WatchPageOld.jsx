  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#131313] text-[#e5e5e5]">
      ...
      <div className="flex flex-col gap-5 p-6 md:flex-row">
        <div className="flex-1 h-[500px] bg-[#1a1a1a] rounded-lg">
          <div className="relative w-full pt-[56.25%] h-[360px] overflow-hidden shadow-lg">
            {currentServer ? (
              <iframe
                src={currentServer}
                title="Video Player"
          ...
          <div className="grid items-center grid-cols-1 gap-4 pt-1.5 md:grid-cols-3">
            ...
            <div className="flex justify-center gap-6 md:col-span-2">
              <button
                // onClick={() => handlePrevNext("prev")}
                // disabled={!hasPrev}
                // className={`w-[180px] py-2 rounded-md font-medium transition
                //   ${hasPrev
        ...
        {/* Episodes */}
        <div className="w-full md:w-[500px] bg-[#1a1a1a] rounded-lg p-4 h-[500px] overflow-y-auto shadow-lg">
      ...
      <div className="px-6 md:px-16 py-10 bg-[#141414] rounded-lg mt-6">
        <div className="flex flex-col gap-8 md:flex-row">
          ...
          <div className="flex-1 px-5 mt-6 text-left md:mt-0">
            ...
            <h2 className="text-md">{titleDetails.chinese_name}</h2>
